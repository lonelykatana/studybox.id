...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Kelola Produk - SIPIO </title>
                            ...
                            <ul class="metismenu" id="menu">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li>
                                            <a href="pembayaran.php">Metode Pembayaran</a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="invert">
                                                    <div class="rem">           
                                                    <a class="aksi" href="/sipo/admin/hapus_produk.php?idproduk=<?php echo $p['idproduk'] ?>">  <input type="submit" name="hapus" class="form-control" value="Hapus" ></a> 
                                                    <a class="aksi" href="/sipo/admin/edit_produk.php?idproduk=<?php echo $p['idproduk'] ?>">  <input type="submit" name="update" class="form-control" value="update" ></a>  
                                                    </form>
                                                </div>
