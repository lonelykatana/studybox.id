...
$lol = query("SELECT * FROM gallery WHERE idpost='$idpost'");
...
<title>Update Gallery- SIPO</title>
...
<div id="myModal" class="modal fade">
        ...
        <?php 
											$brgs=mysqli_query($conn,"SELECT * from gallery");
											$no=1;
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" ><a href="gallery.php">Batal</button>
